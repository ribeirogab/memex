...
- The `.agents/`, `.claude/`, `context/`, and `evals/` directories — maintainer-local content (dogfooded memex output, personal knowledge vault, eval workspaces). Not consumed by `npx skills add` and not part of the published skill surface.
