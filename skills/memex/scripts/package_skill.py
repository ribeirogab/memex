...
skill-creator/scripts/package_skill.py). One change from upstream: the
...
# Make the sibling `quick_validate` module importable regardless of how this
# file is invoked (as a module via `python -m scripts.package_skill`, as a
# script via `python scripts/package_skill.py`, or by absolute path).
