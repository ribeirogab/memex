...
The constitution (`.memex/constitution.md`) is the most important file in the vault. Load this reference when creating, repairing, or auditing it.
...
6. **Knowledge layering** — `.memex/` holds project-specific knowledge only.
...
- Project-specific knowledge lives in `.memex/`. Only add notes here for things unique to {{Project Name}}.
